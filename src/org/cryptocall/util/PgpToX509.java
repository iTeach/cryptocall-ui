...
public class PgpToX509 {
    ...
    public final static String CERT_FILENAME = "cryptocall-cert.pem";
    public final static String PRIV_KEY_FILENAME = "cryptocall-priv-key.pem";
     ...
     */
    public static void createFiles(Context context, PGPSecretKey pgpSecKey, String subjAltNameURI,
            CallbackHandler pgpPwdCallbackHandler) throws NoSuchProviderException, PGPException,
            InvalidKeyException, NoSuchAlgorithmException, SignatureException,
            CertificateException, IOException, UnsupportedCallbackException {

        PasswordCallback pgpSecKeyPasswordCallBack = new PasswordCallback("pgp passphrase?", false);
